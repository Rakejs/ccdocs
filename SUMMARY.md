...
* [Cloneable Code](example/clone.md)
...
* [Random functions](custom-commands/random.md)
* [is Functions](custom-commands/is.md)
* [has functions](custom-commands/has.md)
* [only Functions](custom-commands/only.md)
* [Compact functions](custom-commands/compact.md)
* [Server functions](custom-commands/server.md)
* [Channel functions](custom-commands/channel/README.md)
...
* [Message functions](custom-commands/message/README.md)
  * [reaction related](custom-commands/message/reaction.md)
  * [related functions](custom-commands/message/related.md)
  * [extra functions](custom-commands/message/extra.md)
* [emoji Functions](custom-commands/emoji.md)
* [Mention functions](custom-commands/mention.md)
* [Disable Mention functions](custom-commands/disable.md)
* [Find functions](custom-commands/find.md)
* [Blacklist functions](custom-commands/blacklist.md)
* [delete Functions](custom-commands/delete.md)
* [add Functions](custom-commands/add.md)
* [create Functions](custom-commands/create.md)
* [modify functions](custom-commands/modify.md)
* [db Functions](custom-commands/db.md)
